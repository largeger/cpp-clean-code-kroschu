...
// Lazy Class (barely used in code)
class Library {
public:
    void catalog() {
...
// God Class: Manages multiple responsibilities
class MonasteryManager {
public:
    vector<Monk> monks;
    Library library;

    // Feature Envy: Function accessing Monk data directly
    ...
    // Long Method: Manages brewery with excessive conditionals
    ...
    // Inappropriate Intimacy: Accessing Monk's data fields directly
